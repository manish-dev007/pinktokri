							...
							<div class="form-body">
                               ...
                               <div class="form-group">
								...
								<div class="form-group">
										...
										<div class="form-group">
											<label for="ptax">Product Tax (in %)</label>
											<input type="text" id="ptax" class="form-control"  placeholder="Enter Product Tax" value="<?php echo $selk['ptax'];?>" name="ptax" required>
...
else 
{
	...
	$arr[] = "product/".$file_name;
        ...
        $con->query("update product set pname='".$pname."',sname='".$sname."',ptax='".$ptax."',pimg='".$pimg."',prel='".$related."',popular=".$popular.",discount=".$discount.",cid=".$catname.",sid=".$subcatname.",psdesc='".$psdesc."',pgms='".$pgms."',pprice='".$pprice."',status=".$status.",stock=".$ostock." where id=".$_GET['edit']."");
					...
					<div class="px-3">
						<form class="form" action="#" method="post" enctype="multipart/form-data">
							<div class="form-body">
								...
								<div class="form-group">
									<label for="gurl">Product (Gms,kg,ltr,ml,pcs)</label>
									<input type="text" id="ptype" class="form-control"  name="pgms"  value="" data-role="tagsinput"  required>
									<p>After  write Product Type Press Enter</p>
								</div>
								
								<div class="form-group">
									<label for="gurl">Product Price</label>
									<input type="text" id="pprice" class="form-control"  value="" name="pprice" data-role="tagsinput" required>
									<p>After  write Product Price Press Enter</p>
								</div>
...
else 
{
	...
	$arr[] = "product/".$file_name;
		...
		$con->query("insert into product(`pname`,`pimg`,`prel`,`sname`,`cid`,`sid`,`psdesc`,`pgms`,`ptax`,`pprice`,`date`,`status`,`stock`,`discount`,`popular`)values('".$pname."','".$url."','".$related."','".$sname."',".$catname.",".$subcatname.",'".$psdesc."','".$pgms."','".$ptax."','".$pprice."','".$timestamp."',".$status.",".$ostock.",".$discount.",".$popular.")");
